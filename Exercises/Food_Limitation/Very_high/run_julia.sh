...
#SBATCH --job-name=Food_limit_highhigh       # Job name
...
julia /vortexfs1/scratch/matthew.woodstock/SwimmingIndividuals/Exercises/Food_Limitation/Very_high/model.jl
