using PlanktonIndividuals, Distributions, Random, CSV, DataFrames, StructArrays, JLD2,Statistics,Dates,Optim,LinearAlgebra, Tables, CUDA, LoopVectorization
...
pooled = generate_pools(arch, pool_trait, Npool, g::AbstractGrid, files,maxN,dt)

## Create model object
init_abund = fill(0,Nsp)
model = MarineModel(arch, t, 0,dt, inds, pooled,maxN, Nsp, Npool, B,init_abund, g, files, output_dt, cell_size,spinup)
